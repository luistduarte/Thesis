...
\TitlePage
  ...
  \HEADER{\BAR\FIG{}}
         {\ThesisYear}
      \TITLE{Lu\'is Tiago Marques \newline Duarte}{\textsf{Comparação e implementação de plataformas de} \textit{backend} \textsf{para soluções} \textit{mHealth}}
      \TITLE{}{}
      \TITLE{}{}
  \TITLE{}
...
\TitlePage
  \vspace*{55mm}
  \TEXT{\textbf{Resumo}}
       {Os dispositivos móveis são cada vez mais utilizados na recolha de dados fisiológicos, quer para uso pessoal ou quer para suporte à prestação de cuidados de saúde. Esta área é mais conhecida como \textit{mHealth}. O programador de aplicações \textit{mHealth} precisa desenvolver o \textit{front-end} móvel, para os utilizadores finais e o \textit{backend}, para a integração de sistemas e persistência dos dados recolhidos. Existe várias possibilidades de escolha relativamente à arquitetura a utilizar para o \textit{backend}, que vão desde tecnologias de nível empresarial até tecnologias específicas de determinados domínios da àrea de saúde. Neste trabalho, estudamos como candidatos selecionados para o \textit{backend} das aplicações mHealth (Open mHealth, HL7 FHIR, Google Fit). Foram realizadas implementações exploratórias e lições foram aprendidas.}
    \TEXT{}
