...
Nesta secção serão enumerados todos os casos de uso (cenários-objetivo) da aplicação móvel. O principal ator desta app é o utilizador(alvo de estudo).
...
Nesta secção serão enumerados todos os casos de uso (cenários-objetivo) da aplicação web. O principal ator desta app é o revisor/investigador.
